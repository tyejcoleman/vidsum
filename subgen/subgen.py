...
if __name__ == '__main__':
    convert_to_video()  # creates the audio file
    text = speech2text.mainprogram(audio_file_name="audio.wav") #audio variable is NOT the name
    response = subtitle_generation(response=text, bin_size=3)
